...
- Azure에서 [웹앱](/aspnet/core/tutorials/publish-to-azure-webapp-using-vs)을 만듭니다. 웹앱 URL은 적어두세요. 솔루션에서 필요합니다.
...
- [App Service](/azure-stack/operator/azure-stack-app-service-deploy) PaaS 서비스를 Azure Stack 허브에 배포합니다.
- Azure Stack Hub 환경에서 [계획 및 제안을 만듭니다](/azure-stack/operator/service-plan-offer-subscription-overview).
- Azure Stack Hub 환경 내에 [테넌트 구독을 만듭니다](/azure-stack/operator/azure-stack-subscribe-plan-provision-vm).
